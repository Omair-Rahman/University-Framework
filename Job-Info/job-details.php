  ...
  <body>
    ...
    <section class="py-5 text-center container">
      ...
      <div class="py-3">
        ...
        <div class="py-2">
          <form class="" action="src_job.php" method="post">
            <div class="row input-group ml-5 mb-3">
              <div class="col-sm-10">
                <input type="text" class="hide form-control" id="popupN" name="cName" value="" placeholder="Company Name...">
              </div>
            </div>

            <div class="row input-group ml-5 mb-3" id="uni-field">
              <div class="col-sm-10">
                <input type="text" class="hide form-control" id="popupU" name="jTitle" value="" placeholder="Job Type...">
              </div>
            </div>
            <input type="submit" id="popupS" class=" ml-5 hide btn btn-secondary btn-sm" name="submit" value="FIND!!!">
          </form>
        </div>
      </div>
            ...
            <div class="mb-4 py-4">
              <?php
                if (mysqli_num_rows($sql) > 0)
                {
                  ...
                  {
                    $sqlPost = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM auth WHERE UserName = '$row[UserName]'"));
              ?>
