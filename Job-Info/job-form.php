    ...
    <div class="container">
      ...
      <form name="Form" action="job-validation.php" method="post">
        <div class="row input-group mb-3">
          <label for="inputtitle" class="col-sm-2 col-form-label"><b>Company Name</b></label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="cName" value="" placeholder="Company Name..." required>
          </div>
        </div>
