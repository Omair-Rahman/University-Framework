<?php
  ...
  if (($_POST['cName']=="") AND ($_POST['jTitle']==""))
    header('location:../Job-Info/job-details.php');

  $conn = mysqli_connect("localhost", "root", "", "student_portal");
  if (!$conn)
    die("Connection failed: " . mysqli_connect_error());
  $sql = mysqli_query($conn, "SELECT * FROM jobdata WHERE CompanyName LIKE '%$_POST[cName]%' AND jobTitle LIKE '%$_POST[jTitle]%'");
