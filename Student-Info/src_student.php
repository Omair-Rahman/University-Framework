<?php
  ...
  if (($_POST['fname']=="") AND ($_POST['university']==""))
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container marketing">
      <div class="row">
      <?php
        $sql = mysqli_query($conn, "SELECT * FROM students NATURAL JOIN auth
                            WHERE University LIKE '%$_POST[university]%' AND FullName LIKE '%$_POST[fname]%' AND active = 'Student'");
